...
const components: MDXComponents = {
  ...
  h1: ({ children, ...props }) => (
    <h1 className="text-4xl font-black mb-6 text-foreground my-4" {...props}>
      {children}
    </h1>
  ),
  h2: ({ children, ...props }) => (
    <h2 className="text-3xl font-black mb-5 text-foreground my-4" {...props}>
      {children}
    </h2>
  ),
  h3: ({ children, ...props }) => (
    <h3 className="text-2xl font-bold mb-4 text-foreground my-4" {...props}>
      {children}
    </h3>
  ),
  p: ({ children, ...props }) => (
    <p className="mb-6 text-lg leading-relaxed text-foreground/90 my-4" {...props}>
      {children}
    </p>
  ),
  ul: ({ children, ...props }) => (
